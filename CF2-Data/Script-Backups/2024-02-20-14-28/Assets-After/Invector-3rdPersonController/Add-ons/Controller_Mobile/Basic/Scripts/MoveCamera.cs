    ...
    public class MoveCamera : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        ...
        void HandleTouchDirection()
        {
            if (isPressed)
            {
                ...
                if (currentPointerID >= 0 && currentPointerID < ControlFreak2.CF2Input.touches.Length)
                {                    
                    Vector2 touchPos = ControlFreak2.CF2Input.touches[currentPointerID].position;
                    ...
                    previoustouchPosition = ControlFreak2.CF2Input.touches[currentPointerID].position;
                }
                else
                {

                    Vector2 touchPos = ControlFreak2.CF2Input.mousePosition;// new Vector2(Input.mousePosition.x, Input.mousePosition.y);
                    ...
                    previoustouchPosition = ControlFreak2.CF2Input.mousePosition;
                }
