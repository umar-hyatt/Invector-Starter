...
namespace Invector.vShooter
{
    ...
    public class vControlAimCanvas : MonoBehaviour
    {
        ...
        public void SetWordPosition(Vector3 wordPosition, bool validPoint = true)
        {
            ...
            if (scaleAimWithMovement && (cc.input.magnitude > movementSensibility || ControlFreak2.CF2Input.GetAxis("Mouse X") > movementSensibility || ControlFreak2.CF2Input.GetAxis("Mouse Y") > movementSensibility))
            {
